...
function saveItems() {
    ...
    var xml = '<Items>';
    if (RolesIds.length == 0) { alertMsg("请选择角色！"); }
        ...
        columns: [
            ...
            },
            {
            ...
            },
              {
                  ...
                  title: "操作",
                  template: '#=getOperate(ApplicationId,RoleId,ApplicationIsRoot,RoleIsRoot)#',
                  width: "100px",
                  headerAttributes: {
                      "class": "table-header-cell",
                      style: "text-align: center"
...
function getOperate(applicationId,roleId, appIsRoot, roleIsRoot) {
    var html = "";
    if (appIsRoot && roleIsRoot) {
        html = "";
    }
    else {
        html = '<button class="btn btn-delete btn-danger" onclick="deleteRole(\'' + applicationId + '\',\'' + roleId + '\')">删除</button>';
    }
    return html;
}
