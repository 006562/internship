            ...
            transport: {
                ...
                parameterMap: function (options, operation) {
                    if (operation == "read") {
                        ...
                        var params = '';
                        params += '<root appDomain="{0}" connConfig="{1}" resultType="DatagridDataSource">'.StringFormat(dataSourceOptions.otherOptions.appDomain, dataSourceOptions.otherOptions.connConfig);
