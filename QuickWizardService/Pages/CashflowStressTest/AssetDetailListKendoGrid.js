var kendouiGrid = new kendoGridModel();
kendouiGrid.Init({
    renderOptions: {
        height: 400
        , rowNumber: true
        , columns: [
                    { field: "PayDate", filterable: false, sortable: false, title: '回款日', width: "10%", headerAttributes: { "class": "table-header-cell", style: "text-align: center" }, attributes: { "class": "table-cell", style: "text-align: center" } }
