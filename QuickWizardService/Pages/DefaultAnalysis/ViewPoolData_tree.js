...
var DefaultDataOperation = {
	...
	exportLossData: function(obj) {
		...
		tpi.ShowIndicator('Task', 'ExportStaticPoolLossData', function(result) {
			//code in this place will be executed after the TaskIndicator be closed
		});
    },
    ...
    downloadLossData: function (obj) {
        var $obj = $(obj);
        var regionCode = $obj.attr('regionCode');
		var fileName = orgCode + "_" + assetType + "_" + regionCode + "_LossData.xlsx";
