        ...
        Sections: [{
            ...
            FieldsSetting: {
                ...
                Fields: [
                    ...
                    { ItemId: '5', ItemCode: 'NumOfBuckets', ItemAliasValue: 'Number of Buckets', DataType: '', IsCompulsory: 1, IsDisplay: 1, ItemValue: '400' },
                    {
...
function viewMonteCarlo(){
	window.open(location.protocol + '//' + location.host+"/CashFlowEngine/UITaskStudio/CashFLowDisplayer.html?appDomain=Task&TrustId=1007");
...
function runMonteCarlo(sectionId) {
	...
	tpi.AddVariableItem('DataSetName', dataSetName, 'string', 0, 0, 0);
	...
	tpi.ShowIndicator('Task', 'MonteCarloHistorical', function () {
