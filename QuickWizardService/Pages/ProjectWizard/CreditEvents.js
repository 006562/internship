...
function SaveGridData(obj, fnCallBack) {
    var sectionIndex;
    if (isNaN(obj)) {
...
function Run(obj, fnCallBack) {
    ...
    SaveGridData(sectionIndex, function () {
        ...
        tpi.ShowIndicator('Task', 'CashflowStressTest');
...
var gdvOperation = {
    ...
    OpenDialog: function (obj) {
        ...
        top.GSDialog.Open('&nbsp;&nbsp;&nbsp;&nbsp;', 'Pages/CashflowStressTest/CurveDialog.html', transData, function (result) {
            if (result && result.isSave) {
                var item = viewModel.Sections()[sectionIndex].FieldsSetting.GridView()[itemIndex];//里面包含所有属性
