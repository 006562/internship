...
var dataModel = {
    'zh-CN': {
        Sections: [{
            ...
            Buttons: [
                { Text: '运行', Click: 'runAssetFTP("Section001Identity")', Class: 'btn btn-primary' },
                { Text: '查看', Click: 'viewAssetFTPResult()', Class: 'btn btn-primary' }
            ]
        }, {
            Templ: GlobalVariable.UiTempl_Stand,
            Title: '资产池批量转移定价',
            ...
            Buttons: [
                { Text: '运行', Click: 'runBatchAssetFTP("Section002Identity")', Class: 'btn btn-primary' },
                { Text: '查看', Click: 'viewBatchAssetFTPResult()', Class: 'btn btn-primary' }
            ]
        }]
    },
