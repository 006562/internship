...
function getLanguage(set) {
    ...
    var en_US = { BtnDownLoadShibor:"DownLoadShibor"
				,BtnViewHistoryShiBor:"Result"
				,BtnDownLoadCHINABONGDATA:"DownLoadCHINABONDDATA"
				,BtnViewHistoryCHINABONDDATA:"Result"
				,BtnViewCHINABONDCURVE:"CHINABONDCURVE"
				,BtnViewShiBor:"Result"
				,BtnRun:"Run"
				,BtnView:"Result"
...
$(function () {
    ...
    CallWCFSvc(serviceUrl, false, 'GET', function (data) {
        $.each(data, function (i, v) {
            $('#YieldCurve').append("<option value='" + v.CurveName + "'>" + v.CurveName + "</option>");
        });
    });
