...
var displayColumns = {
    Originator: [
        {
            field: "TrustId", title: "产品ID", sortable: true, attrHeader: settable.tableTh, attr: settable.tableTd
        },
        {
            field: "TrustCode", title: "产品代码", sortable: true, attrHeader: settable.tableTh, attr: settable.tableTd
        },
        { field: "TaskCode", title: "任务代码", sortable: true, attrHeader: settable.tableTh, attr: settable.tableTd },
        {
            field: "IsCashFlowForeCastRequired", title: "允许计算现金流", sortable: false, attrHeader: settable.tableTh, attr: settable.tableTd,
...
var PagerListModule = function () {
    ...
    var syncGetRemoteData = function (gridParams) {
        ...
        executeParam.SQLParams.push({ Name: 'tableName', Value: 'TrustManagement.TrustTaskConfig', DBType: 'string' });
