...
var TaskListManagementModule = function (request) {
    ...
    var renderTrustAssociatedDates = function () {
        var svcUrl = 'https://poolcutwcf/TaskProcessServices/DataProcessService.svc/jsAccessEP/CommonGetExecute?';
        var objArgs = {
    ...
    var uploadSourceFile = function ($file, args, $msg, fnCallback) {
        ...
        $.ajax({
            url: 'https://poolcutwcf/TaskProcessServices/DataProcessService.svc/jsAccessEP/CommonFileUpload' + '?' + args,
            type: 'POST',
            data: fileData,
            cache: false,
            dataType: 'json',
