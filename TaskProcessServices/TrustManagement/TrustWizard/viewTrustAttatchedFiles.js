    ...
    init: function () {
        if (!trustId || trustId <= 0) {
            ...
            TrustAttatchedFileModel.InitArgs('TrustAttatchedFilesDiv',
                'https://poolcutwcf/TaskProcessServices/DataProcessService.svc/jsAccessEP/GetTrustFiles/TrustManagement/',
                'https://poolcutwcf/TaskProcessServices/DataProcessService.svc/jsAccessEP/UploadFile');
            TrustAttatchedFileModel.DataBinding();
        }
    }
};

TRUST.registerMethods(TrustDocumentFile);
