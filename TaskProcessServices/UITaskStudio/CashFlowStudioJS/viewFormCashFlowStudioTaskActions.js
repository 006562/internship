    ...
    var regisUiEvents = function () {
        ...
        $(function () {
            ...
            $("#ribbon_PopTaskInput").click(function () {
                var url = location.protocol + "//" + location.host + "/TaskProcessServices/UITaskStudio/CashFlowInputView.html?r=" + Math.random() * 150;
                var obj = new Object();
            ...
            $("#ribbon_PopResultPannel").click(function () {
                var url = location.protocol + "//" + location.host + "/TaskProcessServices/UITaskStudio/CashFlowRunResult.html?r=" + Math.random() * 150;
                var obj = new Object();
                obj.appDomain = viewGlobalObj.appDomain;
