...
$(function () {
    ...
    if (!trustId || isNaN(trustId) || trustId <= 0) { return; }

    gsTrustEvent.InitPageDataBinding('TrustEventList'
        , trustId
        , 'https://poolcutwcf/TaskProcessServices/DataProcessService.svc/jsAccessEP/GetTrustEvents/TrustManagement/'
        , 'https://poolcutwcf/TaskProcessServices/DataProcessService.svc/jsAccessEP/UpdateTrustEvents'
        , function (dataCount) {
            if (dataCount > 0) {
