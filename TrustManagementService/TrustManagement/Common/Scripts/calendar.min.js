DateInput = (function ($) {
    ...
    DateInput.prototype = {
        ...
        insideSelector: function (event) {
            ...
            var offsetParent = this.dateSelector.offsetParent(),
            // Get correct offsets 
            parentOffset = /^body|html$/i.test(offsetParent[0].tagName) ? { top: 0, left: 0 } : offsetParent.offset();
            var t = offset.top + parentOffset.top, l = offset.left + parentOffset.left;
            var b = t + this.dateSelector.outerHeight(), r = l + this.dateSelector.outerWidth();
        ...
        setPosition: function () {
            ...
            var offsetParent = this.input.offsetParent(),
            // Get correct offsets 
            ...
            this.rootLayers.css({
                top: results.top + this.input.outerHeight(),
                left: results.left
            });
