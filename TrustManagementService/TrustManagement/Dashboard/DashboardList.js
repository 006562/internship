...
function GetSourceData(callback) {
    ...
    var data = ExecuteGetData(false, svcUrlTaskProcess, 'Monitor', executeParam);
...
function bindPayData(list) {
    ...
    $.each(list, function (i, n) {
        if ($.inArray(n.ReportingEndDate, tmpCode) < 0 && (tcarray.length <= 0 || (tcarray.length > 0 && $.inArray(n.TrustName, tcarray) >= 0))) {
