var OriginalOwner = (function () {
    ...
    var gointUpdatedExitedFile = function (obj, gotoUpdated) {
        ...
        if (gotoUpdated) {
            ...
            var fileitem = TrustExtensionNameSpace.TrustExtensionData.DateSetList.BasicData()[index];
    ...
    var getItemValueByItemCode = function (itemcode) {
        var result = "";
        if (itemcode) {
            $.each(TrustExtensionNameSpace.TrustExtensionData.DateSetList.BasicData(), function (i, n) {
