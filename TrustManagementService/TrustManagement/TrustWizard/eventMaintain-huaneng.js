...
var TrustEventMaintainModule = (function () {
    ...
    var qualitativeItemListTemplate = '<li  ItemListId="{0}" CategoryId="{1}" ><span class="check"><span class="list"><i>{3}</i>{2}</span></li>';
    ...
    //渲染当前事件下的定性条目
    var renderQualitative = function (rendId) {
        var content = "";
        var j = -1;
        if (rendId == "selectedQualitativeList") {
        ...
        else if (rendId == "QualitativeList") {
            if (itemEventModel[activeId].ItemList && itemEventModel[activeId].ItemList.length > 0) {
                $(itemEventModel[activeId].ItemList).each(function (i, ItemList) {
        ...
        document.getElementById(rendId).innerHTML = content;
    }
    ...
    var saveItemListExtensionEvent = function (itemId, itemListId) {
        ...
        var executeParam = {
            SPName: 'usp_SaveItemListExtensionEvent', SQLParams: [
                ...
                { Name: 'CalculationCode', value: '', DBType: 'string' }
            ]
        };
                ...
                if (event.IsCheck) {
                    ...
                    $(itemEventModel[i].ItemList).each(function (i, list) {
                        if (list.IsCheck) {
                            ...
                            //eventArray.StartDate, eventArray.EndDate,eventArray.RationSelected, eventArray.QualitativeSelected, 
                        }
                    });
    ...
    var changEvent = function (obj) {
        ...
        renderQualitative("selectedQualitativeList");
        renderQualitative("QualitativeList");
        renderRation();
    }
    ...
    init: function () {
        ...
        $("#selectedQualitativeList, #QualitativeList").sortable({
            ...
            stop: function (event, ui) {
                ...
                //TrustEventMaintainModule.renderSelectedQualitative();
                TrustEventMaintainModule.renderQualitative("selectedQualitativeList");
                TrustEventMaintainModule.renderQualitative("QualitativeList");
                //alert("hello");
            }
        }).disableSelection();
...
TRUST.registerMethods(TrustEventMaintainRegistor);