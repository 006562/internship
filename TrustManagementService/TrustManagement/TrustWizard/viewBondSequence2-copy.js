...
viewBondSequence = function () {
                            ...
                            $.each(trustBondNames, function () {
                                ...
                                for (j = 0; j < currentJson.Jsons.length; j++) {
                                    ...
                                    if (trustBondName == bondLevel) {
                                        ...
                                        content += contentTemplate.format(bondLevel, principalSequenceId, principalSequence, interestSequenceId, interestSequence, vIsCheck, vPercent, vSeqPercent, vIsPrincipalFill);
                                        sequenceNo += 2;
                                        found = true;
                                    }
                                }
    ...
    var writeNewBondLevel = function (trustBondName, sequence) {
        ...
        var vSeqPercent = "";
        var vIsPrincipalFill = "";
        return contentTemplate.format(bondLevel, principalSequenceId, principalSequence, interestSequenceId, interestSequence, vIsCheck, vPercent, vSeqPercent,vIsPrincipalFill);
    }
               ...
               //Fee顺序
                ...
                for (var i = 0; i < arrCheck.length; i++) {
                    if ((i + 1) == arrCheck.length) {
                        currentJson += '{"BondLevel":"' + arrLevel[i] + '","PrincipalSequence":"' + arrSequence[i * 2] + '","InterestSequence":"' + arrSequence[i * 2 + 1] + '","IsCheck":' + arrCheck[i] + ',"Percent":"' + arrOldPercent[i] + '","SSeqMPercent":"' + arrPercent[i] + '","IsPrincipalFill":' + arrIsRest[i] + '}]}';
                    } else {
                        currentJson += '{"BondLevel":"' + arrLevel[i] + '","PrincipalSequence":"' + arrSequence[i * 2] + '","InterestSequence":"' + arrSequence[i * 2 + 1] + '","IsCheck":' + arrCheck[i] + ',"Percent":"' + arrOldPercent[i] + '","SSeqMPercent":"' + arrPercent[i] + '","IsPrincipalFill":' + arrIsRest[i] + '},';
                    }
                }
