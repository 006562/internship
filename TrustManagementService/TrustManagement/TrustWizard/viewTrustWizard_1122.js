...
var TRUST = {
    ...
    init: function () {
        ...
        config.$next.click(function () {
            ...
            if (++self.stepId <= maxStep) {
				...
				var svcUrl=config.tmsDataProcessBase;
				console.log(svcUrl);
                ...
                $.each(updateArray, function (i, n) {
                    ...
                    self.saveWorkingSessionContext(sessionContext, function (sessionId) {
                        ...
                        ExecuteGetData(true, svcUrl, 'TrustManagement', executeParam);
                    });
    ...
    addUrlEvent: function () {
        ...
        if (!sid) { sid = 0; setHashValue('step', sid); }
