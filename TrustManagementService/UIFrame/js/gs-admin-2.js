...
var ribbonRenderTmpl = {
    ...
    groupLi: '<li class="ribbonGroup" module="{0}">{1}<p class="groupTitle">{2}</p></li>',
    maxButton: '<a href="{2}" id="menu-{4}" class="ribbonButton disabled" {3}><i class="{0}"></i><p>{1}</p></a>',
