$(function () {
    ...
    var quickFrame = GlobalVariable.SslHost + 'QuickFrame/';
    ...
    if (userName == null) {
        ...
        var loginURL = quickFrame+"login.html";
        window.top.location.href = loginURL;
        return;
    }
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result == "0") {
                    ...
                    alert("没有权限访问该页面！");
                    window.top.location.href = quickFrame+"login.html";
                }
            },
        ...
        ExecuteGetData(false, serviceUrl, 'TrustManagement', executeParam, function (data) {
            if (data.length > 0) {
                ...
                $.each(response, function (k, v) {
                    if (v.PathName == "TrustWorkBench" && clientCode != "HNGTrust")
                    { return true;}
