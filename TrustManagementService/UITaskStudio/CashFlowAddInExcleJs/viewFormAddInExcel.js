var viewFormAddInExcel = function () {
    ...
    var regisUiEvents = function () {
        ...
        $("#ribbon_Run").bind("click", function () {
            var url = location.protocol + "//" + location.host + "/TrustManagementService/UITaskStudio/CashFlowAddInExcelRunTask.html?r=" + Math.random() * 150;
            var obj = new Object();
        ...
        $("#ribbon_OpenStudio").live("click", function () {
            ...
            var url = location.protocol + "//" + location.host + "/TrustManagementService/UITaskStudio/CashFlowStudio.html?appDomain=" + appDomain + "&taskCode=" + taskCode + "&sessionId=" + sessionID + "&r=" + Math.random() * 150;
            window.open(url);
        });
