...
var RoleOperate = {
    ...
    roleService: location.protocol + "//" + location.host + '/QuickFrame/FrameService.svc/',
    ...
    saveApplicationsRoles: function (xml, callback) {
        var json = "{'DBName':'" + RoleOperate.dbName + "','Schema':'" + RoleOperate.schema + "','SPName':'usp_SaveApplicationsRoleOperate','Params':{'Items':'" + xml + "'}}"
        json = "<SessionContext>{0}</SessionContext>".format(json);
        var serviceUrl = RoleOperate.roleService + "DataCUD";
        $.ajax({
            type: "POST",
    ...
    GetRolesPermissionByUserName: function (userName, callback) {
        var sContent = "{'DBName':'" + RoleOperate.dbName + "','Schema':'" + RoleOperate.schema + "','SPName':'usp_GetRolesPermissionByUserName','Params':{'UserName':'" + userName + "'}}";
        var serviceUrl = RoleOperate.roleService + "DataRead?dbName=" + RoleOperate.dbName + "&schema=" + RoleOperate.schema + "&json=" + sContent;
        $.ajax({
            url: serviceUrl,
            type: "GET",
